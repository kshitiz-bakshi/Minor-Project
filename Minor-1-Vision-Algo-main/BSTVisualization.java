...
public class BSTVisualization extends JFrame implements ActionListener, KeyListener {
    ...
    public JButton btnAdd, btnDelete , btnfeedback;

    public static JButton btnExitTree;
    private JTextField tf;
    private int X = 300, Y = 75;
    private Graphics2D g2;
    private Rectangle size;
    private JLabel labelInorder, labelPreorder, labelPostorder, labelHeight;
    private static JLabel ansInorder;

    private JLabel ansPreorder;

    private JLabel ansPostorder;

    private JLabel ansHeight;
    ...
    public void initialize() {
        ...
        //exit tree
        btnExitTree = new JButton("close Tree");
        btnExitTree.setFont(new Font("Arial", Font.BOLD, 20));
        // btnDelete.setBounds(size.width - 130, 60, 100, 30);
        topRightPanel.add(btnExitTree);

      
        //feedback button 
        //Delete Button
        btnfeedback = new JButton("feedback");
        btnfeedback.setFont(new Font("Arial", Font.BOLD, 20));
        // btnDelete.setBounds(size.width - 130, 60, 100, 30);
        btnfeedback.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                feed.main(new String[]{});
            }
        });
        topRightPanel.add(btnfeedback);

        //last tree made 
        // labelInorder = new JLabel("Previous tree made");
        ...
        // //last tree made answer
        // ansInorder = new JLabel("No records yet");
    ...
    public static void main(String arg[]) {
        ...
        btnExitTree.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {   
                l5.setText("PREVIOUS MADE TREE");
                String s = ansInorder.getText() ; 
                l4.setText(s);
